...
public class MinutePanel extends JPanel {
    ...
    Image bitON = new ImageIcon("Resources\\ON.png").getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH);
    Image bitOFF = new ImageIcon("Resources\\OFF.png").getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH);
    ...
    MinutePanel() {
        this.setBackground(new Color(232, 255, 238));
        this.setBorder(BorderFactory.createMatteBorder(10, 10, 10, 10, new Color(37, 149, 32)));
        this.setLayout(new GridLayout(6, 2));


        JLabel timeLetter1 = new JLabel("M", JLabel.CENTER); //S for second
        JLabel timeLetter2 = new JLabel("M", JLabel.CENTER); //S for second
        ...
        for (int i = 0; i < 8; i++) {
            ...
            bitLabels[i].setBorder(BorderFactory.createMatteBorder(10, 20, 20, 10, new Color(232, 255, 238)));
        }
