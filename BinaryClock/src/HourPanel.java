...
public class HourPanel extends JPanel {
    ...
    HourPanel() {
        ...
        this.setBorder(BorderFactory.createMatteBorder(10, 10, 10, 10, new Color(213, 81, 82)));
        this.setLayout(new GridLayout(6, 2));


        JLabel timeLetter1 = new JLabel("H", JLabel.CENTER); //S for second
        JLabel timeLetter2 = new JLabel("H", JLabel.CENTER); //S for second
        ...
        for (int i = 0; i < 8; i++) {
            ...
            bitLabels[i].setBorder(BorderFactory.createMatteBorder(10, 20, 20, 10, new Color(253, 253, 253)));
        }
